...
if($conn->connect_error){
    die('connection to MYSQL failed:'.$conn->connect_erroe);
}
//create add action
if(isset($_POST['add'])){
    $itemId = $_POST['add'];
...
<!DOCTYPE html>
<head>
    <title>ToDo Lidt Application</title>
...
<body>
    <main>  
        <div class="container pt-5">
            <div class="row">
                <div class="col_sm-12 col-md-3"></div>
                                    ...
                                    while ($row = $result->fetch_assoc()){
                                        ...
                                        <div class="row mt-4">
                                            ...
                                            <div class="col-sm-12 col-md-5">
                                                ...
                                                <a hred="?action=delete&item='.$row['id'].'" class="btn btn-outline-danger">Deleted</a>
                                            </div>
                                        </div>
                                        ';
                                        $i++;
    ...
    <script>
         $(document).ready(function(){
            $(".alert").fadeTo(1000,80).slideUp(80,function(){
                $('.alert').slideUp(80);
            })
        })
